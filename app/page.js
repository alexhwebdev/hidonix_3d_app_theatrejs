...
export default function App() {
  ...
  // Camera initialization and animation on page load
  useEffect(() => {
    let raf;
    ...
    function tryAnimateCamera() {
      ...
      if (!cam) {
        ...
        // requestAnimationFrame keeps retrying until initialCameraRef.current is available.
        raf = requestAnimationFrame(tryAnimateCamera);
        return;
      }
  
      cam.position.set(20, 10, 30); // initial position
  
      const target = cameraTargets.Scene1;
      ...
      >
        ...
        <group ref={cameraOffsetGroupRef}>
          <PerspectiveCamera 
            ...
            near={1}
            position={[20, 10, 30]} 
            // position={[cameraTargets.Scene1.x, cameraTargets.Scene1.y, cameraTargets.Scene1.z]} 
